    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-4 lg:p-8">
        <div className="mb-6 lg:mb-8">
          <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-2">Đổi Mật Khẩu</h2>
          <p className="text-sm lg:text-base text-gray-600">Cập nhật mật khẩu để tăng cường bảo mật tài khoản</p>
        </div>
        ...
        {successMessage && (
          <div className="mb-4 lg:mb-6 p-3 lg:p-4 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-xs lg:text-sm text-green-800">{successMessage}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {passwordError && (
          <div className="mb-4 lg:mb-6 p-3 lg:p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-xs lg:text-sm text-red-800">{passwordError}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4 lg:space-y-6">
          <div>
            <label htmlFor="currentPassword" className="block text-xs lg:text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            <label htmlFor="newPassword" className="block text-xs lg:text-sm font-medium text-gray-700 mb-2">
        ...
        <div className="mt-6 lg:mt-8 p-3 lg:p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-xs lg:text-sm font-medium text-yellow-800">Lưu ý bảo mật</h3>
