    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-4 lg:p-8">
        <div className="mb-6 lg:mb-8">
          <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-2">Thông Tin Ngân Hàng</h2>
          <p className="text-sm lg:text-base text-gray-600">Quản lý thông tin tài khoản ngân hàng của bạn</p>
        </div>
        ...
        {bankError && (
          <div className="mb-4 lg:mb-6 p-3 lg:p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-xs lg:text-sm text-red-800">{bankError}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4 lg:space-y-6">
          <div>
            <label htmlFor="bankName" className="block text-xs lg:text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            <label htmlFor="accountNumber" className="block text-xs lg:text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            <label htmlFor="accountHolder" className="block text-xs lg:text-sm font-medium text-gray-700 mb-2">
        ...
        <div className="mt-6 lg:mt-8 p-3 lg:p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg className="h-4 w-4 lg:h-5 lg:w-5 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
            </div>
            <div className="ml-3">
              <h3 className="text-xs lg:text-sm font-medium text-blue-800">Lưu ý bảo mật</h3>
