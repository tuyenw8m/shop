    ...
    <div className='bg-white rounded-lg shadow-sm'>
      ...
      <div className='px-4 lg:px-6 py-3 lg:py-4 border-b border-gray-200'>
        <div className='relative'>
          ...
          />
          <div className='absolute left-3 lg:left-4 top-1/2 transform -translate-y-1/2 text-gray-400'>🔍</div>
        </div>
      </div>
        ...
        <div className='space-y-3 lg:space-y-4 max-h-[calc(100vh-400px)] overflow-y-auto'>
          {isLoading ? (
            <div className='text-center py-8 lg:py-12'>
              ...
              <h3 className='text-base lg:text-lg font-medium text-gray-900 mb-2'>Đang tải đơn hàng...</h3>
              <p className='text-sm lg:text-base text-gray-500'>Vui lòng chờ trong giây lát</p>
            </div>
                          ...
                          {cartItem.isCartItem && (
                            <div className='flex items-center gap-2 lg:gap-4 mb-3'>
                              ...
                              <div className='flex items-center space-x-1 lg:space-x-2 border border-gray-300 rounded-lg bg-white'>
                                ...
                                <span className='w-8 lg:w-12 text-center font-medium text-sm lg:text-base'>
                                  {cartItem.quantity}
                                </span>
                                <button
                                  onClick={() =>
